(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('core-js/modules/es.array.reduce')) :
	typeof define === 'function' && define.amd ? define(['exports', 'core-js/modules/es.array.reduce'], factory) :
	...
	var parseErrorSchema = function parseErrorSchema(error) {
	  return Array.isArray(error.inner) && error.inner.length ? error.inner.reduce(function (previous, _ref) {
	    ...
	    return previous;
	  }, {}) : _defineProperty({}, error.path, error.message);
	};
	        ...
	        while (1) {
	          switch (_context.prev = _context.next) {
	            ...
	            case 8:
	              ...
	              return _context.abrupt("return", {
	                values: {},
	                errors: parseErrorSchema(_context.t2)
	              });
